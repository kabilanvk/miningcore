...
echo 'Host: $PERSISTENCE_POSTGRES_USER'
echo 'Host: $PERSISTENCE_POSTGRES_PASSWORD'
echo 'Host: $PERSISTENCE_COSMOS_ENDPOINTURL'
echo 'Host: $PERSISTENCE_COSMOS_AUTHORIZATIONKEY'
echo 'Host: $PERSISTENCE_COSMOS_DATABASEID'
